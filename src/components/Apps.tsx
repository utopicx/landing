            ...
            <div className="md:mx-auto md:max-w-2xl">
                ...
                <div className="md:mt-4 md:grid md:grid-cols-2">
                    {app?.Image ? (
                        ...
                        <div
                            className="mx-auto mt-8 h-72 w-56 rounded-bl-lg rounded-tr-lg bg-gray-600 bg-opacity-95 md:mr-0 md:mt-0 lg:h-80 lg:w-60"/>
                    )}
                    <div
                        className="relative z-10 mx-2 mt-8 md:mt-0 md:flex md:flex-col md:justify-between md:pr-32 lg:pr-0">
                        ...
                        <div className="flex gap-x-1 md:justify-start md:gap-x-4">
                            <a
                                ...
                                rel="noreferrer"
                                onClick={() => {
                                    AnalyticsService.pushEvent("click", {
                                        name: app?.name,
                                        url: app?.URLAndroid,
                                        platform: "android",
                                    });
